...
rt=read.table("C:\\Users\\anxin\\Desktop\\integrated_model\\testdiff.txt", header=T, sep="\t", check.names=F)    
...
write.table(GO, file="C:\\Users\\anxin\\Desktop\\integrated_model\\testGO.txt", sep="\t", quote=F, row.names = F)
...
print(bar)
ggsave("testGO_barplot.pdf", bar, width = 12, height = 8, dpi = 300) 
...
print(bub)
ggsave("testGO_bubplot.pdf", bub, width = 12, height = 8, dpi = 300) 
