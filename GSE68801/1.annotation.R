...
library(tidyr)
library(stringr)
probe_matrix <- read.table("C:\\Users\\anxin\\Desktop\\integrated_model\\GSE68801\\GSE68801_series_matrix.txt", header = TRUE, row.names = 1)
platform_file <- read.table("C:\\Users\\anxin\\Desktop\\integrated_model\\GSE68801\\GPL570-55999.txt", 
...
write.csv(merged_data, "C:\\Users\\anxin\\Desktop\\integrated_model\\GSE68801\\GSE68801annotated_probe_matrix.csv", row.names = TRUE)
