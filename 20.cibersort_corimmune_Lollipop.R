...
#"cor.KRT83ult.txt" below should be replaced for other two genes
data = read.table("C:\\Users\\anxin\\Desktop\\integrated_model\\cor.KRT83ult.txt", header=T, sep="\t", check.names=F)
...
pdf(file="Lollipop_KRT83.pdf", width=9, height=7) 
